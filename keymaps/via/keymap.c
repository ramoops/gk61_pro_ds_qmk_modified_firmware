...
// this is from modified qmk firm, but doesnt seem to work so yeah fuck it
/*
...
uint16_t get_tapping_term(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case RSFT_T(KC_UP):
            return TAPPING_TERM; //right shift hold time less than default tapping term 80ms
        default:
            return TAPPING_TERM;
    }
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN_INDEX] =  LAYOUT_all(
        ...
        _______,  TO(2),    TO(0),    TO(1),  _______,  _______,     _______,  _______,  _______,  _______,  RGB_M_P,  RGB_RMOD, RGB_RMOD, RGB_TOG,
        _______,  _______,  _______,  _______,  _______,  _______,     _______,  _______,  KC_INSERT,  KC_PRINT_SCREEN,  RGB_SPD,  RGB_SPI,            _______,
        _______,  _______,  _______,  _______,  _______,  _______,     KC_HOME,  KC_END,  RGB_VAD,  RGB_VAI,  KC_UP,              _______,
...
bool enabled_cancellation = false;
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case TO(2):
        if (record->event.pressed) {
            enabled_cancellation = !enabled_cancellation;
        }
        return true; // continue all further processing of this key
